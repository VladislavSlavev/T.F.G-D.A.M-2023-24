...
class SeleccionarUbicacion : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ocultar el layout listo al principio
        binding.listoLinearlayout.visibility = View.GONE
        ...
        // Configuracion del fragmento de autocompletado de places
        ...
        autocompleteSupportMapFragment.setOnPlaceSelectedListener(object : PlaceSelectionListener{
            override fun onPlaceSelected(place: Place) {
                ...
                // Cuando se selecciona un lugar desde el autocompletado se obtienen los detalles del lugar y se agrega el marcador
                val id = place.id
                val name = place.name
        ...
        binding.IbGps.setOnClickListener {
            ...
            // Llamar al evento para acceder a la ubicacion actual
            if (esGpsActivado()){
        ...
        binding.BtnListo.setOnClickListener {
            ...
            // Al hacer click en listo se devuelve la ubicación seleccionada a la actividad anterior
            val intent = Intent()
    ...
    // Elegir la ubicacion actual en el mapa sacada de la funcion detectAndShowDeviceLocationMap
    ...
    // Detectar y mostrar la ubicacion actual en el mapa
    ...
    // Manejar permisos para la ubicacion
    @SuppressLint("MissingPermission")
    ...
    // Cuando el mapa esta listo solicita los permisos de ubicacion
    ...
    // Obtener una direccion a partir de las coordenadas
    ...
    // Agregar el marcador en la ubicacion seleccionada
    private fun agregarMarcador(latlng: LatLng, titulo : String, direccion : String){
        ...
        try {
            ...
            binding.listoLinearlayout.visibility = View.VISIBLE
